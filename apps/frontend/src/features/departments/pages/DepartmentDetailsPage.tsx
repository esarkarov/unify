import { DepartmentClass, DepartmentDetails, DepartmentSubject, DepartmentUser } from '@/features/departments/types';
        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <div className="rounded-lg border border-border bg-muted/20 p-4">
              ...
              <div className="mt-2 text-2xl font-semibold">{details.totals.subjects}</div>
            </div>
            <div className="rounded-lg border border-border bg-muted/20 p-4">
              <div className="flex items-center justify-between text-xs font-semibold text-muted-foreground">
              ...
              <div className="mt-2 text-2xl font-semibold">{details.totals.classes}</div>
            </div>
            <div className="rounded-lg border border-border bg-muted/20 p-4">
              <div className="flex items-center justify-between text-xs font-semibold text-muted-foreground">
              ...
              <div className="mt-2 text-2xl font-semibold">{details.totals.enrolledStudents}</div>
            </div>
          </div>
        </CardContent>
      </Card>
