...
import { InputPassword } from '@/shared/components/refine-ui/form/input-password';
    ...
    <div className={cn('flex', 'flex-col', 'items-center', 'justify-center', 'px-6', 'py-8', 'min-h-svh')}>
      ...
      <Card className={cn('sm:w-[456px]', 'p-12', 'mt-6')}>
        <CardHeader className={cn('px-0')}>
          <CardTitle className={cn('text-blue-600', 'dark:text-blue-400', 'text-3xl', 'font-semibold')}>
            Sign in
          </CardTitle>
          <CardDescription className={cn('text-muted-foreground', 'font-medium')}>Welcome back</CardDescription>
        </CardHeader>
