...
import { RefreshButton } from '@/shared/components/refine-ui/buttons/refresh';
...
export const ShowViewHeader = ({
  ...
  const title =
    titleFromProps ?? getUserFriendlyName(resource?.meta?.label ?? identifier ?? resource?.name, 'singular');
  ...
  return (
    <div className={cn('flex flex-col', 'gap-4', wrapperClassName)}>
      ...
      <div className={cn('flex', 'gap-1', 'items-center', 'justify-between', '-ml-2.5', headerClassName)}>
